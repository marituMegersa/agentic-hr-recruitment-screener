...
class AgenticHrRecruitmentScreenerSession(Base):
    __tablename__ = "hr_recruitment_screener_sessions"
...
class AgenticHrRecruitmentScreenerItem(Base):
    __tablename__ = "hr_recruitment_screener_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("hr_recruitment_screener_sessions.id"))
